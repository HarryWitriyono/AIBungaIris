...
<html lang="en">
<head>
  <title>Data uji - SIM AI KNN Bunga Iris V. 2025</title>
  <meta charset="utf-8">
...
<div class="container">
  <h1>Tabel Data uji - SIM AI KNN Bunga Iris V. 2025</h1>
<form method="post">
...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO `datauji`(`sepal_length`, `sepal_width`, `petal_length`, `petal_width`, `IdClass`) VALUES ('".$sepal_length."','".$sepal_width."','".$petal_length."','".$petal_width."','".$IdClass."')";
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" data-bs-dismiss="modal" formaction="koreksidatauji.php">🖌️ Koreksi Rekord</button>
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" formaction="hapusdatauji.php">🗑️ Hapus Rekord</button>
      </div>
