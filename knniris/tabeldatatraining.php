...
<div class="container mt-3">
  <h2>Tabel Data Training - SIM AI KNN Bunga Iris V. 2025</h2>
  ...
  <table class="table table-hover">
    ...
    <tbody>
        <?php $sql1="SELECT d.*,j.NamaKelas,j.fotobunga FROM `datatraining` d inner join jenisbunga j on d.IdClass=j.IdClass";
